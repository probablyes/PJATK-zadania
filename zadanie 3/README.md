...
Uwagi dodatkowe: 
       • nale¿y siê przygotowaæ na to, ¿e w pliku jest dowolna iloœæ liczb, • wobec tego nale¿y u¿yæ klasy ArrayList do wczytywania danych, ale wymaganie stworzenia tablicy te¿ jest obowi¹zkowe. 
	   
Utworzona przez generator projektów klasa Main zawiera fragment pomocny dla uzyskania wymaganej nazwy pliku. Klasê Main nale¿y uzupe³niæ, tak, aby uzyskaæ w³aœciwe rozwi¹zanie. 
